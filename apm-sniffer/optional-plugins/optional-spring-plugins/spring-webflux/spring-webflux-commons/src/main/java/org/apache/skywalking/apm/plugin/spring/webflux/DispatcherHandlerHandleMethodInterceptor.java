...
package org.apache.skywalking.apm.plugin.spring.webflux;
...
public abstract class DispatcherHandlerHandleMethodInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    protected void maybeSetPattern(AbstractSpan span, ServerWebExchange exchange) {
        if (span != null) {
